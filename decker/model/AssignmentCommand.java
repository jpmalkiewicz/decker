...
final class AssignmentCommand extends ScriptNode
{
	...
	public Value execute ()  {
		...
		Value ret = null, v;
		if (variable.getOperator() == Expression.VARIABLE && (v=stack[stack_size-1].get("expandable")) != null && v.equals(true) && !stack[stack_size-1].get("structure_type").equals("LOCAL")) {
		...
		else if (value_definition instanceof Expression && ((Expression)value_definition).getOperator() == Expression.ORIGINAL_VALUE)
